...
class FaceMorpher:
    ...
    def extract_feature_mask(self, image, landmarks, feature_list):
    ...
    def morph_feature(self, source_img, target_img, feature_list, alpha):
        ...
        source_feature_mask = self.extract_feature_mask(aligned_source, aligned_source_landmarks, feature_list)

        # Extract same feature mask from target (for smooth blending)
        target_feature_mask = self.extract_feature_mask(target_img, target_landmarks, feature_list)
